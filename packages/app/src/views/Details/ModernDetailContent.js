...
const ModernDetailContent = (props) => {
	const {
		...
		handleOpenVersionModal, handleOpenServerModal, handleOpenAudioModal, handleOpenSubtitleModal, handleOpenPlaylistModal, handleOpenCollectionModal, handleOpenDeleteDialog,
	...
	const renderActionButtons = () => {
		...
		const offered = [
			...
			{id: 'server', when: hasMultipleServers, render: () => <ActionButton path={DETAIL_ICON_PATHS.server} label={$L('Server')} onClick={handleOpenServerModal} />},
