		...
		subcategories: [
			...
			},
			{
				...
				rows: [
					...
					{kind: KIND.OPTION, key: 'recommendationSystemSource', label: () => $L('Recommendation Source'), desc: () => $L('Choose recommendation algorithm for Details page'), options: getRecommendationSystemSourceOptions, fallback: () => $L('Moonfin Recommends'), icon: 'folder_code'},
			...
			},
			{
				...
				rows: [
					...
					{kind: KIND.OPTION, key: 'sinceYouWatchedSource', label: () => $L('Source'), options: getSinceYouWatchedSourceOptions, fallback: () => $L('Moonfin Recommends'), icon: 'folder_code', when: whenSinceYouWatched},
